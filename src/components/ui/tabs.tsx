...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex items-center min-w-none overflow-hidden justify-start flex-nowrap rounded-lg bg-gray-200 p-0 text-muted-foreground/70 inset-shadow-sm/15',
      className
    )}
    {...props}
  />
